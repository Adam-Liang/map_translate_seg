...
if __name__=="__main__":
    ...
    paths=[r"D:\map_translate\看看效果\0829\9.5\9.5.0\real_source",
           r"D:\map_translate\看看效果\0829\9.5\9.5.0\real_result",
           r"D:\map_translate\看看效果\0829\9.5\9.5.0\fake_result",
           r"D:\map_translate\看看效果\0829\9.5\9.5.0\seg_result",]

    path_new=r"D:\map_translate\看看效果\0829\9.5\9.5.0\overlap"

    make_flod_img(paths,path_new)
    print("finish!")

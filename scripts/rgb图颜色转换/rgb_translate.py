...
old_rgb = np.array([239,238,236])
new_rgb = np.array([220,220,220])
...
def make_change_img(dir_old, dir_new):
    ...
    for img in tqdm(imgs_old):
        ...
        new.save(os.path.splitext(os.path.join(dir_new,img_inner))[0]+'.png')
        num+=1
...
if __name__ == "__main__":
    flag = 1
    # 首先解析文件路径
    path_old = r"D:\map_translate\写作相关\latex内容\latex内容\配图\素材\131967335_tostand"
